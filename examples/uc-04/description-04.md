...
For that:
- The patient has a [policy](policy-04.ttl) allows a subset of her health data to be read for primary care.
- The physician issues a [request](request-04.ttl) to read a subset of health data for primary care with consent as legal basis.

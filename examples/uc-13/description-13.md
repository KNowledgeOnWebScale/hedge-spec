...
For that:
- The user has a [policy](policy-13.ttl) that allows a subset of her health data to be read by a non-healthcare professional for 24h.
- The non-healthcare professional issues a [request](request-13.ttl) to read a subset of health data for 24h with consent as legal basis.
...
- Data subject: <https://example.org/user13>
...
- Data subject (type): <https://example.org/user13>
- Data/Personal data: <https://example.org/lab-test-results>
